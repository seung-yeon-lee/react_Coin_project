...
// 아래는 셀렉터 모듈화 ( createSelector.js ) 작성 후 수정 한 코드
...
// 셀렉터 생성 함수를 참조 후 기존 셀렉터 함수들을 구현한 코드

// 액션,리듀서, 셀렉터를 모두 모듈화 했으므로 새로운 종류가 추가되어도
// 빠르게 비동기 작업을 포함한 기능을 완성가능
// 회원가입 구현하기 => action => userAction.js (회원가입 액션 추가하기)
